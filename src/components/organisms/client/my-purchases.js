...
import { Avatar, Col, DocsContentWrapper, Input, List, Paragraph, Row, Select } from '../../atoms';
...
for (let i = 0; i < 45; i += 1) {
  purchasesData.push({ title: 'title' });
}
        ...
        pagination={{
          ...
          showTotal: (total, current) => (
            <Paragraph type='secondary' fw={400} fz={16}>
              Showing {current[0]}-{current[1]} of {purchasesData.length}
            </Paragraph>
          ),
        }}
